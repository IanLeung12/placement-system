...
public class Warehouse {
    ...
    /**
     * loadBoxes
     * adds the boxes to a file
     * @param f File
     */
    public void loadBoxes(File f){
    }
    ...
    /**
     * loadTrucks
     * loads the trucks from truck ArrayList on a certain file
     * @param f File
     */
    public void loadTrucks(File f){
    ...
    public static class PlacementSystem {
        ...
        public void loadBoxesToTruck(ArrayList<Box> boxes, Truck truck) {
            ...
            for (Box box: truck.getBoxes()) {
                box.setCords(truck.getLength() - 1 - box.getPositionYInTruck() - box.getLength(),
                        truck.getLength() - 1 - box.getPositionXInTruck() - box.getLength());
            }
        }
